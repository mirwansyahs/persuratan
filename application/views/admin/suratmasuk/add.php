<div class="card">
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <form id="form1" method="POST" action="<?=base_url()?>admin/suratmasuk/addProccess" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="inputjudul_surat">Judul <span class="text-sm text-danger">*</span></label>
                        <input type="text" id="inputjudul_surat" class="form-control form-control-sm" name="judul_surat" required>
                    </div>
                    <div class="form-group">
                        <label for="inputTanggal">Tanggal Surat <span class="text-sm text-danger">*</span></label>
                        <input type="date" id="inputTanggal" class="form-control form-control-sm" name="tanggal_surat" required autocomplete="off" value="<?=date('Y-m-d')?>">
                    </div>
                    <div class="form-group">
                        <label for="inputberkas">Berkas</label>
...
{
    $.ajax({
        url     : '<?=base_url()?>admin/suratmasuk/addProccess',
        type    : 'POST',
